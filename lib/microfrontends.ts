...
export const microfrontends: Record<string, MicrofrontendConfig> = {
    'portfolio-master': {
        ...
        url: process.env.NEXT_PUBLIC_PORTFOLIO_URL || '/static/finanzas/index.html',
        icon: 'TrendingUp',
        color: '#10B981',
    ...
    'dashboard-financiero': {
        ...
        url: (process.env.NEXT_PUBLIC_PORTFOLIO_URL || '/static/finanzas/index.html') + (process.env.NEXT_PUBLIC_PORTFOLIO_URL ? '/?view=simulator' : '#simulator'),
        icon: 'BarChart3',
        color: '#6366F1',
        get available() { return this.url !== ''; },
    },
